...
const ConfigSchema = z.object({
  ...
  appLoginUsernameLocator: z.string().optional(),
  appLoginPasswordLocator: z.string().optional(),
  appLoginSubmitLocator: z.string().optional(),
...
export function loadConfig(): Config {
  ...
  const raw = {
    ...
    appLoginUsernameLocator: env.APP_LOGIN_USERNAME_LOCATOR || undefined,
    appLoginPasswordLocator: env.APP_LOGIN_PASSWORD_LOCATOR || undefined,
    appLoginSubmitLocator: env.APP_LOGIN_SUBMIT_LOCATOR || undefined,
